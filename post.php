...
<main>
    ...
    <section class="content-container">
        <div class="post-detail post-detail-article" x-data="commentReplyManager()">
            <!-- 文章主体 -->
                        ...
                        <div class="post-time-comment" x-data="{ptcmShow: false}"
                            ...
                            <div class="post-time-comment-modal" x-show="ptcmShow"
                                ...
                                <div class="ptcm-good like-menu-btn" data-cid="<?php echo $this->cid; ?>"
                                    ...
                                    <span class="like-menu-text">赞</span>
                                </div>
                            ...
                            foreach ($comments as $comment) {
                                ...
                                <div class="pcc-comment-item"
                                    ...
                                    <span class="cursor-help pcc-comment-content"
                                          @click="showReplyForm($event, '<?php echo $this->cid; ?>', '<?php echo $comment['coid'] ?? $comment['id'] ?? 0; ?>', <?php echo htmlspecialchars(json_encode($comment['author'], JSON_UNESCAPED_UNICODE), ENT_QUOTES, 'UTF-8'); ?>)"><span class="pcc-comment-text"><?php echo htmlspecialchars($comment['text'], ENT_QUOTES, 'UTF-8'); ?></span></span>
                                </div>
                                <?php
                                foreach ($comment['replies'] as $reply) {
                                    ...
                                    <div class="pcc-comment-item"
                                        ...
                                        <span>:</span>
                                        <span class="cursor-help pcc-comment-content"
                                              @click="showReplyForm($event, '<?php echo $this->cid; ?>', '<?php echo $reply['coid'] ?? $reply['id'] ?? 0; ?>', <?php echo htmlspecialchars(json_encode($reply['author'], JSON_UNESCAPED_UNICODE), ENT_QUOTES, 'UTF-8'); ?>)"><span class="pcc-comment-text"><?php echo htmlspecialchars($reply['text'], ENT_QUOTES, 'UTF-8'); ?></span></span>
                                    </div>
                                    <?php
                                }
                            }
